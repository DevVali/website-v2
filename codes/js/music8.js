...
$httpPost[$var[host]/volume/$guildID;{"volume":$sum[$getServerVar[volume];10]}]

$author[Volume Set]
$authorIcon[https://cdn.discordapp.com/attachments/889423777123938315/942487760797839370/2213-tune.png]
$description[🔊  The volume is now **$sum[$getServerVar[volume];10]%**.]
$setServerVar[volume;$sum[$getServerVar[volume];10]]
